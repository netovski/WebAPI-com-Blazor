...
namespace BlazorClientesNet8.Repositories
{
    public class ClienteRepository : IClienteRepository
    {
        ...
        public async Task<Cliente> AddClienteAsync(Cliente model)
        {
            ...
            var chk = await _context.Clientes.Where(_ => _.Name.ToLower()
                                    .Equals(model.Name.ToLower())).FirstOrDefaultAsync();
        ...
        public async Task<List<Cliente>> GetAllClientesAsync() => await _context.Clientes.ToListAsync();
